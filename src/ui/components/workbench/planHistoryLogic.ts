...
export function restorePrompt(
  ...
  // In-place since 2026-08-31 (History is a results tab on the mounted Plan
  // page again): the workbench takes the restored plan the moment the call
  // returns and re-runs it — no "next time you open it".
  const opening = `Restore ${what}? It becomes the current plan and runs right away.`;
